...
<template>
  <AuthLayout>
    <div class="bg-white p-8 pt-6 rounded-md">
      ...
      <a-form ref="formRef" :model="form" :rules="formRules" layout="vertical" size="large" @submit="handleSubmit">
        ...
        <a-form-item field="username" label="用户名">
          <div class="w-96">
            <a-input v-model="form.username" placeholder="请输入用户名（非必填）" />
          </div>
        </a-form-item>
        ...
        <a-form-item>
          <a-button :loading="submitLoading" html-type="submit" type="primary" class="w-full">注册</a-button>
        </a-form-item>
      </a-form>
      <p class="text-xs text-gray-600">进行注册则表示您同意 Aite 的
        <a href="" class="text-primary border-b border-transparent hover:border-primary transition-all">服务条款</a>
        和
        <a href="" class="text-primary border-b border-transparent hover:border-primary transition-all">隐私权政策</a>
        。
      </p>
